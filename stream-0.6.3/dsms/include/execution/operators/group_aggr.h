...
namespace Execution {
	...
	private:
		...
		// Xing: Calculate the LUB
		unsigned int aggrLUBLevel[5];
	...
	public:		
		...
		// Xing: Add the following functions for LUB computations
	//	void updatePlusLUBLevel(int level);
	//	void updateMinusLUBLevel(int level);
		// unsigned int getLUBLevel();
